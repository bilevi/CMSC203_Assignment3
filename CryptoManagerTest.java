...
public class CryptoManagerTest  {
	...
	public static void main(String[] args) {
		...
		System.out.println("Caesar cipher of \""+str4+"\" should return \"WKLV#LV#DQRWKHU#WHVW\":   "+ CryptoManager.encryptCaesar("B. Leigh Vining", 93));
		System.out.println("Bellaso cipher of \""+str4+"\" should return \"WU\\VR9F#N!RF88U-'HED\":    "+ CryptoManager.encryptBellaso("B. Leigh Vining", "BLV"));
		System.out.println("Caesar decryption of \""+str5+"\" should return \"THIS IS ANOTHER TEST\":    "+ CryptoManager.decryptCaesar("", 93));
		System.out.println("Bellaso decryption of \""+str6+"\" should return \"THIS IS ANOTHER TEST\":    "+ CryptoManager.decryptBellaso("", "BLV"));
	}
